...
# tr [opciones] conjunto1 conjunto2Donde conjunto1 es el conjunto de caracteres que se deben buscar y reemplazar y conjunto2 es el conjunto de caracteres con los que se deben reemplazar los caracteres de conjunto1.
